...
const OrderFood=({route,navigation})=>{
  ...
  function editOrder(action,menuId,price){   // ฟังชั่น การเพิ่ม item 
    ...
    function getBasketIteemCount(){   // process number product 
      let itemCount = orderItems.reduce((a, b) => a + (b.qty || 0) , 0)
      
      return itemCount;
    }

    function sumOrder(){            // total salary product                   
            ...
            <View>
                ...
                >
                    <View 
                      ...
                      <Text style={{...FONTS.h3}}>{getBasketIteemCount()} items in Cart</Text>
                          ...
                          <View style={{ flexDirection: 'row' }}>
                                <Image
                                  ...
                                  resizeMode="contain"
                                    ...
                                    <Text style={{
                                      marginLeft:SIZES.padding, ...FONTS.h4
                                    }}>Location</Text>
                            </View>
                            <View style={{ flexDirection: 'row' }}>
                            <Image

...
export const red_pin = require("../assets/icons/red-pin.png");      // import {icons} from '../constants';
export const rice_bowl = require("../assets/icons/rice-bowl.png");    // icons.cutlery
...
export const shares = require("../assets/icons/share.png");
export const mapdark = require("../assets/icons/mapdark.png");
export const hotel = require("../assets/icons/hotel.png");
export const shop = require("../assets/icons/shop.png");
export const camera = require("../assets/icons/camera.png");
export const qrcodes = require("../assets/icons/qrcodes.png");
